-- Fix RLS policy for document verification - SIMPLIFIED VERSION
-- This removes the second_opinion_lawyer_id check which may not exist yet
...
-- Create simple UPDATE policy for lawyers
