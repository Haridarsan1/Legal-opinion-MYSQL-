...
export default function LawyerMessagesContent() {
    ...
    return (
      <div className="flex flex-col items-center justify-center h-96 text-center">
        ...
        <p className="text-gray-600 max-w-md">
          You don't have any assigned cases yet. Messages will appear here once you are assigned to
          a case.
        </p>
      </div>
    );
    ...
    <div className="flex flex-col lg:flex-row gap-6 h-[calc(100vh-12rem)]">
      ...
      <div className="lg:w-1/3 bg-white rounded-xl border border-gray-200 overflow-hidden flex flex-col">
        <div className="border-b border-gray-200 p-4">
          <h2 className="font-bold text-lg text-gray-900">Client Conversations</h2>
          <p className="text-sm text-gray-600">{requests.length} active case(s)</p>
        </div>
      ...
      <div className="lg:w-2/3 flex-1">
        {selectedRequest && selectedRequest.client && currentUserId ? (
          <MessageThread
            requestId={selectedRequest.id}
            requestNumber={selectedRequest.request_number}
            recipientId={selectedRequest.client.id}
            recipientName={selectedRequest.client.full_name}
