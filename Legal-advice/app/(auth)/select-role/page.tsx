...
export const metadata: Metadata = {
  title: 'Select Your Role - Legal Opinion Portal',
  description: 'Choose your role to access the appropriate dashboard',
};
...
export default function SelectRolePage() {
  return (
    <div className="bg-background-light min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* Main Card Container */}
      <main className="w-full max-w-[700px] relative z-10">
        {/* Back Button */}
        <div className="mb-4">
          <BackButton href="/auth/signup" />
        </div>
        ...
        <div className="bg-white rounded-xl shadow-xl border border-slate-200 overflow-hidden">
          ...
          <div className="px-8 pb-10 relative">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-slate-500 text-base font-normal leading-relaxed px-4">
